/**
* This class is contains a barebones setup for a typical Hash Table with OA Quadratic Probing structure.
...
class HashTableOAQuadraticProbe <K, V> {
    ...
    */
    ...
    public HashTableOAQuadraticProbe() {
    ...
    */
    boolean insert(K key, V value) {
        ...
        while (currentNode != null && currentNode.getKey() != key && currentNode != deletedNode) {
            index = insertKey + step * step; //[h(key) + step*step] % MAX_LENGTH
            index %= MAX_LENGTH;
            step++;
    ...
    */
    boolean remove(K key) {
        ...
        while (currentNode != null) {
            ...
            index = removeKey + step * step; //[h(key) + step*step] % MAX_LENGTH
            index %= MAX_LENGTH;
            step++;
            currentNode = table[index];
        }
    ...
    */
    Optional<V> get(K key) {
        ...
        while (currentNode != null) {
            ...
            index = searchKey + step * step; //[h(key) + step*step] % MAX_LENGTH
            index %= MAX_LENGTH;
            step++;
            currentNode = table[index];
        }
